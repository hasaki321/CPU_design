...
HD_PWD='N:/CCP_design/test/test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_gate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_gate.tcl
